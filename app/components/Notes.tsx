    ...
    return(
        <>
            <div className="flex justify-between items-center">
                ...
                <button onClick={toggleNotes} className="bg-blue-500 py-2 px-5 rounded-full hidden md:flex gap-2 text-white font-bold cursor-pointer hover:bg-blue-500/80 items-center">
